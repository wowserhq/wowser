 ...
 * https://github.com/kanaka/websockify/blob/master/include/websock.js
 */
...
function Websock() {
  ...
  function open(uri) {
    ...
    websocket.onopen = function() {
      eventHandlers.open(websocket.protocol);
    };
