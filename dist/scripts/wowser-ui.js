...
Wowser.ui.screens.Authentication = (function() {
  function Authentication($scope, $rootScope) {
    var _this = this;
    this.$scope = $scope;
    this.$rootScope = $rootScope;
    this.session = new Wowser(Wowser.expansions.wotlk);
    this.host = 'localhost';
    this.username = '';
    this.password = '';
    ...
    this.session.auth.on('authenticate', function() {
      _this.$rootScope.state = 'realm-selection';
  ...
  Authentication.prototype.connect = function() {
    return this.session.auth.connect(this.host);
  };
