...
Screen = (function() {
  ...
  function Screen($scope, $element) {
    ...
    this.scene.add(axes);
    this.load('Creature\\Rabbit\\Rabbit.m2.3geo', 'Creature\\Rabbit\\RabbitSkin.blp.png', (function(_this) {
      return function(model) {
        return _this.scene.add(model);
      };
    })(this));
    this.load('Creature\\RAGNAROS\\RAGNAROS.m2.3geo', 'Creature\\RAGNAROS\\RAGNAROSSKIN.blp.png', (function(_this) {
      return function(model) {
        return _this.scene.add(model);
      };
    })(this));
